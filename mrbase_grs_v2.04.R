##########################################################################################
#Script name: mrbase_grs_v2.04.r
#Project: GRS_SEP
...
#Update 2.03: Updated the clumping code to have a default 10,000 kb window, same as MR Base, and added options to allow changes
