##########################################################################################
#Script name: mrbase_grs_v2.05.r
#Project: GRS_SEP
...
mrbase_grs = function(output=NULL,category=NULL,subcategory=NULL,trait=NULL,population=NULL,sex=NULL,mr=NULL,samplesize=0,
                      ...
                      proxies=TRUE,clump=TRUE,clump_kb=10000,clump_r2=0.001,clumped=TRUE,gwas="biggest",suffix="",
                      snpstats_file="SNPstats.txt",ld_file="1000_genomes_ld.csv.gz",eur_file = "eur",keep_files=FALSE,plink_grs=FALSE,
